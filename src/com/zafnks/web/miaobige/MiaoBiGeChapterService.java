...
public class MiaoBiGeChapterService extends AbstractChapterService {

    private final static String TABLENAME = "novel_miaobige";

    private final static String CHAPTER_DB = "miaobigeDB";

    private final static String ECODING = "GBK";
    
    private final static String WEB = "miaobige";
    
    private final Pattern pattern = Pattern.compile("http.?://[0-9a-zA-Z.?#]+/");
    ...
    protected List<Chapter> getAllChapter(String rootUrl, Document doc) {
        ...
        try {
            Element mulu = doc.getElementsByAttributeValue("id", "readerlists").get(0);
